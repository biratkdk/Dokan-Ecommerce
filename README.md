...
Dokan Ecommerce is a 5-credit academic project developed using Python and Django. The application is presented through a Redstore-themed storefront interface and implements a complete ecommerce workflow covering product browsing, cart management, checkout, payments, order tracking, returns, customer support, analytics, and API integration.

## Historical Note

This repository contains the maintained and extended version of the original academic submission. The codebase includes later improvements in deployment, analytics, APIs, reliability, and operations.
...
- incorporate AI and ML-style analytical components for recommendations and customer insight
...
This project includes classical AI and ML-style modules aligned with an academic project scope. It does not rely on modern LLM-based architecture. Instead, it focuses on practical analytical features that can be implemented and explained clearly within a Python ecommerce system.
...
- baseline storefront and catalog model established first
- transactional flows added next: cart, checkout, and order handling
- quality pass completed through validation, cleanup tasks, and deployment checks

## Assessment-Oriented Deliverables

- documented architecture and module boundaries
- reproducible local setup and migration steps
- tested business workflows for checkout, orders, and support
- deployable configuration with operational checks

## Documentation Change Snapshot

This repository keeps iterative documentation updates so project scope, implementation details, and deployment notes remain clear and reviewable over time.
